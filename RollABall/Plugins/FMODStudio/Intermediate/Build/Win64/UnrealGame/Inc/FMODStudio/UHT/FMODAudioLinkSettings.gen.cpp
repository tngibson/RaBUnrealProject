...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_LinkEvent = { "LinkEvent", nullptr, (EPropertyFlags)0x0044000000004001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UFMODAudioLinkSettings, LinkEvent), Z_Construct_UClass_UFMODEvent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_LinkEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_LinkEvent_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_bShouldClearBufferOnReceipt = { "bShouldClearBufferOnReceipt", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UFMODAudioLinkSettings), &Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_bShouldClearBufferOnReceipt_SetBit, METADATA_PARAMS(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_bShouldClearBufferOnReceipt_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_bShouldClearBufferOnReceipt_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_ProducerToConsumerBufferRatio = { "ProducerToConsumerBufferRatio", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UFMODAudioLinkSettings, ProducerToConsumerBufferRatio), METADATA_PARAMS(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_ProducerToConsumerBufferRatio_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_ProducerToConsumerBufferRatio_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_InitialSilenceFillRatio = { "InitialSilenceFillRatio", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UFMODAudioLinkSettings, InitialSilenceFillRatio), METADATA_PARAMS(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_InitialSilenceFillRatio_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_InitialSilenceFillRatio_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_LinkEventResolved = { "LinkEventResolved", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UFMODAudioLinkSettings, LinkEventResolved), Z_Construct_UClass_UFMODEvent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_LinkEventResolved_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::NewProp_LinkEventResolved_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UFMODAudioLinkSettings_Statics::ClassParams = {
		...
		0,
		0x001010A6u,
		METADATA_PARAMS(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UFMODAudioLinkSettings_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_FMODStudio_Source_FMODAudioLink_Public_FMODAudioLinkSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFMODAudioLinkSettings, UFMODAudioLinkSettings::StaticClass, TEXT("UFMODAudioLinkSettings"), &Z_Registration_Info_UClass_UFMODAudioLinkSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFMODAudioLinkSettings), 2472231769U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_FMODStudio_Source_FMODAudioLink_Public_FMODAudioLinkSettings_h_1687840247(TEXT("/Script/FMODStudio"),
