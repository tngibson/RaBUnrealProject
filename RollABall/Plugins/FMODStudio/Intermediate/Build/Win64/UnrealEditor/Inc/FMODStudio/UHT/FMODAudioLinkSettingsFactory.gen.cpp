...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UFMODAudioLinkSettingsFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UFMODAudioLinkSettingsFactory_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UFMODAudioLinkSettingsFactory_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_FMODStudio_Source_FMODAudioLinkEditor_Private_FMODAudioLinkSettingsFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFMODAudioLinkSettingsFactory, UFMODAudioLinkSettingsFactory::StaticClass, TEXT("UFMODAudioLinkSettingsFactory"), &Z_Registration_Info_UClass_UFMODAudioLinkSettingsFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFMODAudioLinkSettingsFactory), 2565921659U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_FMODStudio_Source_FMODAudioLinkEditor_Private_FMODAudioLinkSettingsFactory_h_3937882963(TEXT("/Script/FMODStudio"),
